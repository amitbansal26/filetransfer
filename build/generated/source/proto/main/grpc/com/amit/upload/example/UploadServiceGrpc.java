...
public final class UploadServiceGrpc {
  ...
  public static final String SERVICE_NAME = "grpcdemo.UploadService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.amit.upload.example.Chunk,
      com.amit.upload.example.UploadStatus> getUploadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Upload",
      requestType = com.amit.upload.example.Chunk.class,
      responseType = com.amit.upload.example.UploadStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.amit.upload.example.Chunk,
      com.amit.upload.example.UploadStatus> getUploadMethod() {
    io.grpc.MethodDescriptor<com.amit.upload.example.Chunk, com.amit.upload.example.UploadStatus> getUploadMethod;
      ...
      synchronized (UploadServiceGrpc.class) {
        if ((getUploadMethod = UploadServiceGrpc.getUploadMethod) == null) {
          UploadServiceGrpc.getUploadMethod = getUploadMethod =
              io.grpc.MethodDescriptor.<com.amit.upload.example.Chunk, com.amit.upload.example.UploadStatus>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.amit.upload.example.UploadStatus.getDefaultInstance()))
  ...
  public static abstract class UploadServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.amit.upload.example.Chunk> upload(
        io.grpc.stub.StreamObserver<com.amit.upload.example.UploadStatus> responseObserver) {
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                ...
                com.amit.upload.example.UploadStatus>(
